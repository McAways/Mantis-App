...
def abrir_popup_selecao_pessoas():
    ...
    # Botão de iniciar coleta
    ttk.Button(frame_popup, text="Iniciar Processo", command=lambda: iniciar_coleta({**selecoes_pessoas, **selecoes_envio}, popup), bootstyle="info"
        ).pack(pady=10)
...
style = ttk.Style("temamantis-comune")
...
date_entry_inicio = DateEntry(
    frame_campos,
    width=12,
    bootstyle="info",  # Estilo do ttkbootstrap
    dateformat="%d/%m/%Y"
)
