...
def abrir_popup_selecao_coleta():
    ...
    selecoes = {
        ...
        "Coleta de planilhas": [tk.BooleanVar(), coleta_de_planilhas]
    }
...
ttk.Button(frame_selecao, text="Confirmar Seleção", command=confirmar_selecao, bootstyle="primary").grid(
    row=3, column=2, columnspan=1, pady=10)
ttk.Button(frame_selecao, text="Enviar Marcações", command=enviar_marcacoes, bootstyle="primary").grid(
    row=5, column=0, columnspan=1, pady=5, padx=5)
ttk.Button(frame_selecao, text="Envio", command=abrir_popup_selecao_pessoas, bootstyle="primary").grid(
    row=5, column=1, columnspan=1, pady=5, padx=5)
ttk.Button(frame_selecao, text="Coleta", command=abrir_popup_selecao_coleta, bootstyle="primary").grid(
    row=5, column=2, columnspan=1, pady=5, padx=5)

# Log de mensagens
log_widget = tk.Text(frame_selecao, height=10, width=60)
log_widget.grid(row=6, column=1, pady=5, padx=5, sticky="e")
